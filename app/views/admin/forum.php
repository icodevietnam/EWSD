			...
			<form class="save-form">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input id="txtType" name="txtType" class="form-control" type="text" placeholder="Enter type" required />
					</div>
					<div class="form-group">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form class="delete-form">
				...
				<div class="modal-body">
					<p class="confirm-message">Are you sure you want to delete this forum?</p>
				</div>
				<div class="modal-footer">
...
\helpers\assets::js(array(
						helpers\url::admin_template_path() . 'js/forumAdmin.js')
); ?>