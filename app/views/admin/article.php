			...
			<form class="save-form">
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<input id="txtTitle" name="txtTitle" class="form-control" type="text" placeholder="Enter name" required />
					</div>
					<div class="form-group">
						<label for="txtContent">Content: </label>
						<textarea id="txtContent" name="txtContent" class="form-control" placeholder="Enter content" required ></textarea>
					</div>
				</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form class="delete-form">
				...
				<div class="modal-body">
					<p class="confirm-message">Are you sure you want to delete this article?</p>
				</div>
				<div class="modal-footer">
