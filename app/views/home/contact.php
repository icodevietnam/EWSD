	...
	<div class="container">
				<div class="row">
					<div class="col-md-6">
						...
						<p>
						Please don't hesitate to contact to us if you have any concern.
						</p>
					...
					<div class="col-md-6">
						<div class="row">
							<div class="col-md-6">
								...
								<div class="contact-info">
									<h5>Address</h5>
									<p>1st Greenwich, Greenwich district, Greenwich city, England</p>
						...
						<p>
						Please keep in touch with us. You are our future.
						</p>						
					</div>
				</div>
			</div>
